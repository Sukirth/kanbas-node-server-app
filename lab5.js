...
const lab5 = (app) => {
    ...
    ///a5/todos/:id/completed/:completed
    ...
    ///a5/todos/:id/description/:description
    ...
    app.get("/a5/assignment", (req, res) => {res.json(assignment);});
    ...
    app.get("/a5/calculator/", (req, res) => {
        ...
        switch (operation){
            case "add":
                res.send(`${a}+${b} = ${parseInt(a)+parseInt(b)}`.toString());
            case "subtract":
                res.send(`${a}-${b} = ${parseInt(a)-parseInt(b)}`.toString());
            default:
                res.send("unrecognised operation");       
        }
